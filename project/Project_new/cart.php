...
<html>
<head>
    <title>TE: Your Shopping Cart</title>
...
<div class="header">
	  ...
	  <a href="welcome.php"><input type= "button" style="float:right; margin-right: 80px; margin-top: 20px;font-size: 18px;"class="button" value="Back to Home Page"/></a>
</div>
<table cellpadding="2" cellspacing="2" border="1" style="margin-left: 140px; margin-top: 20px;">
	<tr>
...
<button ng-click="makePaypalPayment()" class="btn btn-info" style="margin-top: 20px; margin-bottom: 40px; "></button>
